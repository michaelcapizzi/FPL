...
def get_player_keys(player_dict):
    ...
    :return: <list> of keys
    """
    return ["player_id", "last_name", "first_name", "team"] + list(player_dict["history"][0].keys())


# TODO add data for last_name, first_name, and team
def update_player_dataframe(existing_df, gw_dict, player_id, i2p_lookup, p2t_lookup):
    """
